...
export const methods: Method[] = [
  // ────────────── Prioritization ──────────────
  {
    ...
    benefits: [
      'Forces you to name a reach estimate, which often reveals features that only help a sliver of users',
  ...
  },
  {
    ...
    benefits: [
      'Fast enough to score 30 ideas in a meeting',
  ...
  },
  {
    ...
    pitfalls: [
      'Scoring Job Size as days rather than Fibonacci, which breaks the ratio',
  ...
  },
  {
    ...
    whenNotToUse:
      'Ongoing continuous delivery with no release boundary, where the buckets lose meaning without a deadline.',
    benefits: [
  ...
  },
  {
    ...
    category: 'prioritization',
    tldr: 'Simplest prioritization tool: a 2×2 of value and effort. Quick Wins, Big Bets, Fill-ins, Time Sinks.',
  ...
  },
  {
    ...
    pitfalls: [
      ...
      'Ignoring Cost of Delay for infrastructure, where the bill comes due with interest',
    ],
    example: {
  ...
  // ────────────── Discovery ──────────────
  {
    ...
    pitfalls: [
      'Writing the job as the feature ("When I want a CSV export, I want the export button"), which is tautology',
  ...
  },
  {
    ...
    pitfalls: [
      'Asking "would you use this?" is worthless; everyone says yes',
  ...
  },
  {
    ...
    pitfalls: [
      'Stopping at the first human-error cause ("the dev made a mistake"), which is never the root',
  ...
  },
  {
    ...
    whenNotToUse: 'Small reversible decisions, where overhead exceeds value.',
    benefits: [
    ...
    limitations: [
      ...
      '~45-minute exercise, so skip for small decisions',
    ],
    pitfalls: [
  ...
  },
  {
    ...
    whenNotToUse: 'Team under 8, where OKRs become bureaucracy. Use a simpler list.',
    benefits: [
  ...
  },
  {
    ...
    limitations: ['Five metrics is a lot to track per feature', 'Happiness is attitudinal, so expensive to measure continuously'],
  },
  {
    id: 'aarrr',
  ...
  },
  {
    ...
    benefits: ['Forces one-page discipline', 'Lives on the wall; a visible artifact beats a buried doc'],
  ...
  },
  {
    ...
    whenNotToUse: 'Small incremental features, where it is overkill.',
    benefits: [
  ...
  },
  {
    ...
    category: 'decision',
    tldr: 'Voice disagreement openly in the meeting. Once decided, commit fully, with no undermining.',
  ...
  },
  {
    ...
    limitations: ['User trust cost; the apology experience matters', 'Ethics questions in regulated contexts'],
  },
  {
    id: 'wizard-of-oz',
    name: 'Wizard of Oz',
