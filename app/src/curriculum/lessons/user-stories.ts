...
export const userStories: ConceptLessonContent = {
  ...
  takeaways: [
    'User stories follow "As a [user], I want [goal], so that [benefit]" — and the "so that" is where the value lives.',
  ...
  check: {
    questions: [
      ...
      },
      {
        ...
        options: [
          { id: 'a', label: 'V — Valuable: it describes internal plumbing, not value to a user.' },
          { id: 'b', label: 'S — Small: tables are always large.' },
          { id: 'c', label: 'N — Negotiable: tables can’t be discussed.' },
        ],
        correctId: 'a',
