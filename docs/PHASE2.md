...
| W2-C | Engine board confidence + expectations + fired fail-state + end-of-season summary + deterministic job-market offers. Engine-only. | ⬜ |
| W2-D | Sim presentation rebuild: inbox turn (messages from people, decision sheets w/ telegraphed effects, rationale, commit→cliffhanger). | ⬜ |
